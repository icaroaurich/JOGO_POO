...
public class portasNivel03 extends portas{
    ...
    public void porta0202(World world)
    {
        ...
        Actor Player_1 = getOneIntersectingObject(Player_1.class);
        int y = getY();
        int x = getX();        
        if (x == 520 && y == 456){
            //setRotation(180); // sul
            ...
            if (Player_1 !=null){
                Greenfoot.setWorld(new Nivel02Sala03(940,230));}
        }
    }
    ...
    public void porta0217(World world){
        ...
        if (x == 520 && y == 456){
            //setRotation(180); // sul
            if (Player !=null){
                Greenfoot.setWorld(new Nivel02Sala10(583,87));}
        } 
    }
}
